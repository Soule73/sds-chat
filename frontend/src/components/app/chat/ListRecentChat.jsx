...
export default function ListRecentChat({ activeSection }) {
    return <div className={`${activeSection !== 1 && "hidden"} w-full h-[calc(100%-10rem)] custome-scroll-bar max-h-[calc(100%-10rem)] overflow-auto xl:overflow-hidden xl:hover:overflow-y-auto `}>
        <Menu>
            <MenuHandler>
